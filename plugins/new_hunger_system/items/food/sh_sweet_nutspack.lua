ITEM.name = "Ореховое ассорти"
ITEM.description = "Пакет с орехами, отлично восстанавливающий голод."
ITEM.longdesc = "Маленький пакетик, наполненный орехами различных видов, обычно смешанных или одного вида. Он может быть использован в качестве перекуса или добавлен к другому блюду для придания вкуса и текстуры. Пакетик обычно имеет простой дизайн, с информацией о виде орехов и весе."
...
ITEM.functions.use = {
    ...
    OnRun = function(item)
        ...
        ix.util.PlayerPerformBlackScreenAction(item.player, "Употребление...", 4, function(player) 
			ix.chat.Send(player, "me", "достаёт пакет с ореховым ассорти и употребляет горсть орешков.")
		end)
