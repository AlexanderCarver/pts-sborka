ITEM.name = "Бутылка воды"
ITEM.description = "Маленькая бутылка на 0,5 литра."
...
function ITEM:PopulateTooltipIndividual(tooltip)
	...
	ix.util.PropertyDesc2(tooltip, "Чистая вода", Color(64, 224, 208), Material("vgui/ui/stalker/armorupgrades/hunger.png"))
end
...
ITEM.functions.use = {
    ...
    OnRun = function(item)
        ...
        ix.util.PlayerPerformBlackScreenAction(item.player, "Употребление...", 4, function(player) 
			ix.chat.Send(player, "me", "достаёт бутылкой с водой и делает несколько глотков, освежая себя.")
		end)
