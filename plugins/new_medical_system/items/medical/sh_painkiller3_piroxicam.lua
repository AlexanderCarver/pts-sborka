ITEM.name = "Пироксикам"
ITEM.description = "Таблетки в хорошо защищенной упаковке."
ITEM.longdesc = "Лекарственное средство, нестероидный противовоспалительный препарат из группы оксикамов. Как и другие НПВП, неселективно ингибирует фермент циклооксигеназу."
...
ITEM.functions.use = {
	...
	OnRun = function(item)
		...
		ix.util.PlayerPerformBlackScreenAction(item.player, "Употребление...", 4, function(player) 
			...
			ix.chat.Send(player, "me", "достаёт упаковку пироксикама и выдавливает одну из таблеток в свою ладонь, после чего глотает её.")
		end)
