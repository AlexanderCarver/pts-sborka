ITEM.name = "Калия йодид"
ITEM.description = "Таблетки в хорошо защищенной упаковке."
ITEM.longdesc = "Неорганическое соединение, калиевая соль иодоводородной кислоты с химической формулой KI. Бесцветная кристаллическая соль, желтеющая на свету. Широко используется в качестве источника иодид-ионов."
...
ITEM.functions.use = {
	...
	OnRun = function(item)
		...
		ix.util.PlayerPerformBlackScreenAction(item.player, "Употребление...", 8, function(player) 
			player:AddBuff("buff_radprotect", 300, { amount = item.restore/60 })
			ix.chat.Send(player, "me", "достаёт упаковку калия йодида и выдавливает большую таблетку в свою ладонь, после чего с трудом глотает её.")
		end)
