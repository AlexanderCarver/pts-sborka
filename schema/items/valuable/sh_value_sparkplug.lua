ITEM.name = "Свеча зажигания"
ITEM.description = "Свеча зажигания от двигателя."
ITEM.longdesc = "Свеча зажигания для двигателя. Полезно для жителей зоны, которые используют генераторы для питания своих жилищ."
